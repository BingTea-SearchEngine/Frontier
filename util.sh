...
while true; do
    ...
    if pgrep -x "$PROCESS_NAME" > /dev/null; then
        ...
        nohup ./build/Frontier -n 500000000 -b 50 -l /home/wbjin/Frontier/seedList.txt -f 20000 -c 30000 -s /home/wbjin/Frontier/frontier_save.txt --recover > ~/FrontierLog.txt 2>&1 &
    fi
